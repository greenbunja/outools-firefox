...
pageMod.PageMod({
	include: /.*todayhumor.co.kr\/board\/view.php.*/,
	contentScriptFile: [data.url("jquery.js"),
...
pageMod.PageMod({
	include: /.*todayhumor.co.kr\/board\/list.php.*/,
	contentScriptFile: [data.url("jquery.js"),
...
pageMod.PageMod({
	include: [/.*todayhumor.co.kr\/board\/write.php.*/,
        	  /.*todayhumor.co.kr\/board\/modify.php.*/],
	contentScriptFile: [data.url("jquery.js"),
...
var offBGMs = cm.Item({
 	label: "이글의 BGM 제거",
	context: cm.URLContext(/.*todayhumor.co.kr\/board\/view.php.*/),
	contentScript: 'self.on("click", function() {' +
				   '	self.postMessage();' +
	               '});',
	onMessage: function() {
